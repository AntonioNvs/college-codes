...
if __name__ == "__main__":
    ...
    #     Token('RPR', TokenType.RPR)
    # ])
    # let x <- w -1 in ~w end end end

    e = Let("v", Mul(Num(2), Add(Num(1), Num(1))), 
            Let("w", Mul(Var("v"), Add(Var("v"), Num(5))), 
            Let("x", Sub(Var("w"), Num(1)), Neg(Var("w")))
        ))
