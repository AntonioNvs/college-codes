...
if __name__ == "__main__":
    tk0 = Token('(', TokenType.LPR)
    tk1 = Token('fn', TokenType.FNX)
    tk2 = Token('x', TokenType.VAR)
    tk3 = Token('=>', TokenType.ARW)
    tk4 = Token('fn', TokenType.FNX)
    tk5 = Token('y', TokenType.VAR)
    tk6 = Token('=>', TokenType.ARW)
    tk7 = Token('x', TokenType.VAR)
    tk8 = Token('+', TokenType.ADD)
    tk9 = Token('y', TokenType.VAR)
    tk10 = Token(')', TokenType.RPR)
    tk11 = Token('3', TokenType.NUM)
    tk12 = Token('2', TokenType.NUM)
