...
class TypeCheckVisitor(Visitor):
    ...
    def visit_ifThenElse(self, exp, env):
        ...
        Usage:
            ...
            <class 'int'> -> <class 'int'>
        """
        if exp.cond.accept(self, env) == type(True) and exp.e0.accept(self, env) == exp.e1.accept(self, env):
    ...
    def visit_app(self, exp, env):
        ...
        if isinstance(fval, ArrowType) and exp.actual.accept(self, env) == fval.hd:
            return fval.tl
        else:
            sys.exit("Type error")
